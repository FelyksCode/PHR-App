...
final queuedObservationsProvider = FutureProvider<List<Map<String, dynamic>>>((ref) async {
  final queueService = ref.watch(offlineQueueServiceProvider);
  return queueService.getQueuedObservations();
});

// Provider to get queued conditions data
final queuedConditionsProvider = FutureProvider<List<Map<String, dynamic>>>((ref) async {
  final queueService = ref.watch(offlineQueueServiceProvider);
