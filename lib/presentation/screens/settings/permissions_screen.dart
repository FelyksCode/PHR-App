...
class _PermissionsScreenState extends ConsumerState<PermissionsScreen> {
          ...
          child: ConstrainedBox(
            ...
            child: Column(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    for (int i = 0; i < HealthPermissions.permissionCategories.length; i++) ...[       
                      _buildPermissionItem(
                        category: HealthPermissions.permissionCategories[i],
                      ),
                      if (i < HealthPermissions.permissionCategories.length - 1)
  ...
  Widget _buildPermissionItem({
    required HealthPermissionCategory category,
  }) {
  ...
  Future<void> _requestPermissions() async {
    ...
    try {
      ...
      final healthConnectInstalled = await healthService.isHealthConnectInstalled();
      ...
      if (hasAllPermissions) {
        ...
        final grantedPermissions = await healthService.getGrantedPermissions(permissions: permissions);
                    ...
                    onPressed: () async {
                      try {
                        ...
                        if (mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text('Please manually install Health Connect from Play Store: ${installError.toString()}'),
                              backgroundColor: const Color(0xFFFF9500),
                              behavior: SnackBarBehavior.floating,
                            ),
                          );
