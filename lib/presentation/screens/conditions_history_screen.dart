    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () async {
          ...
          await ref.refresh(latestConditionsProvider);
          await ref.refresh(queuedConditionsProvider);
        },
              ...
              ...paginatedConditions.reversed.map((condition) {
                ...
                return ListTile(
                  ...
                  leading: CircleAvatar(
                    backgroundColor: _getSeverityColorFromString(condition['severity'] as String? ?? '').withOpacity(0.1),
                    child: Icon(
                  ...
                  trailing: Container(
                    ...
                    decoration: BoxDecoration(
                      color: isQueued
                          ...
                          : _getSeverityColorFromString(condition['severity'] as String? ?? '').withOpacity(0.1),
              ...
              ...paginatedConditions.reversed.map((condition) {
                ...
                return ListTile(
                  ...
                  trailing: Container(
                    padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                    decoration: BoxDecoration(
                      color: _getSeverityColorFromString(condition['severity'] as String? ?? '').withOpacity(0.1),
                      borderRadius: BorderRadius.circular(12),
                    ),
                    child: Text(
