...
class _DashboardScreenState extends ConsumerState<DashboardScreen> {
      ...
      child: Column(
        children: [
          ...
          Padding(
            ...
            child: _isMonthView ? _buildMonthCalendar() : _buildWeekCalendar(),
          ),
          const SizedBox(height: 16),
        ],
      ),
  ...
  Widget _buildReminderCard(BuildContext context, AppLocalizations l10n) {
    final reminders = ref.watch(notificationRemindersProvider);
    final upcomingReminders = reminders.where((r) => r.enabled && !r.isComplete).toList();
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 2),
                      Text(
                        upcomingReminders.first.time.format(context),
                        style: const TextStyle(
                          fontSize: 12,
                          color: Color(0xFF8E8E93),
                        ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    ref.read(notificationRemindersProvider.notifier).updateReminder(
                      reminder.copyWith(isComplete: true),
                    );
